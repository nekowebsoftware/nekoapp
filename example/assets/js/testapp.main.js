//========================================================================================
//     Neko Web Application - The framework and/or tool to easily create own web applications
//     This test application used to demonstrate what framework can do
//     Copyright (C) 2019  S.V.G
//----------------------------------------------------------------------------------------
...
//     http://nekoweb.ddns.net/nekoapp/LICENSE.txt
//----------------------------------------------------------------------------------------
//     For JavaScripting guide, visit nekoweb.ddns.net/docs/nekoapp/js_guide
//     For JavaScript API, visit nekoweb.ddns.net/docs/nekoapp/js_api
//========================================================================================
...
var testapp = new nekoapp({                                                                     //  Registering your application
        ...
        introElement : {																		//  Element for introduction
            ...
            prototype : {
				...
				loadIntro : function() {														//  Loads introduction content and appends into introduction element
					var container = this;
					nekoapp.system.xhr().load("intro/"+this.locale+".html", {					//  Performs a GET request to receive content
			...
			moduleContents : function() {
				var elements = {
					...
					darkModeLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/system/darkMode.html", {
					...
					customElementsLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_guide/preferences.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					modulesLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_guide/modules.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					windowsLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_guide/windows.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					localeLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_guide/locale.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					createLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/object.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					resourceManagerLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/resources.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					xhrManagerLink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/system/xhr.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
			...
			moduleContents : function() {
				var elements = {
					...
					buttonlink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/button.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					checklink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/checkbox.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					radiolink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/radiobutton.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					textboxlink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/textbox.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
					...
					comboboxlink : nekoapp.create.element(testapp, "p", {
						text : nekoapp.create.link(testapp, "docs/js_api/create/combobox.html", {
							useDefaultNavigation : true ,
							target : "_blank" ,
    ...
    applicationLocalization : {                                                                 //  Your application localization
        "en-US" : {																				//  Use ISO language codes
            URL : "assets/locale/testapp/en-us.json"											//  URL to JSON strings table
        } ,
        "ru-RU" : {
            URL : "assets/locale/testapp/ru-ru.json"
        }
    }
});
